function f = heatscatter(f, X, Y, numbins, markersize, marker, plot_colorbar, plot_lsf, xlab, ylab, title)
...
%     end
    ...
    %f = figure();
    scatter(X, Y, markersize, scatter_COL, marker);%,'MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5
